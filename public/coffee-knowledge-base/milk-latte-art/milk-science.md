---
title: Milk Science, Steaming & Latte Art
category: Milk & Latte Art
subcategory: Technique & Science
difficulty: Intermediate
tags: [milk, steaming, microfoam, latte-art, proteins, fat, rosetta, tulip, heart, plant-milk]
summary: Complete science of milk steaming, microfoam creation, and latte art pours for dairy and non-dairy milks.
sources:
  - "Gunning, P.A. et al. (2004). The effect of polysaccharide on the structure of whipped cream. Food Hydrocolloids."
  - "Huppertz, T. (2010). Foaming properties of milk. International Dairy Journal."
  - "Barista Hustle — Milk Series"
  - "SCA Barista Skills curriculum"
created_at: 2025-01-01
scientific_accuracy_score: 9/10
verification_status: verified
related_topics: [espresso-machines, barista-workflow, sensory-training]
reading_time: 16 min
---
...
```mermaid
flowchart LR
    A["Phase 1: STRETCH\nAir incorporation\n~37–55°C\nWand just below surface\nHissing sound\nIncreases volume"] --> B["Phase 2: SPIN/ROLL\nTexturing & emulsifying\nWand deeper, off-center\nRolling vortex\n55–65°C\nSilk the foam"]
```
...
```mermaid
flowchart LR
    A["Pitcher at 45°\nhigh up\nfill cup 40%\nno pattern yet"] --> B["Lower pitcher\nclose to surface\nstart wiggling\npattern begins"] --> C["Raise pitcher\ncut through center\nfinish pattern"]
```
