...
const PUNS = [
  ...
  "Whisker me another latte.",
  "Paws and sip.",
  "Mew've got great taste.",
  "Bean there, brewed that.",
  "The purr-fect roast awaits.",
  "No hiss, just bliss.",
  "Sip happens.",
  "Caffeine and cuddles.",
  "Wake up and smell the cat-puccino.",
  "One more cup? Fur sure.",
  "Latte love from your barista cat.",
  "Powered by beans and whiskers.",
  "Every bean has a dream.",
  "Serving pawsitivity daily.",
  ...
  "Today's lesson: drink coffee.",
  "Knowledge, served hot.",
  "Learning never tasted so good.",
  "Discovering one bean at a time.",
  "Brewing answers, not just coffee.",
  "Fresh facts, no decaf.",
  "Unlocking the secrets of the roast.",
  "Exploring the world, one bean at a time.",
  "The answer is probably coffee.",
  "Roasting myths, serving facts.",
  "Coffee wisdom incoming.",
  "Knowledge brewed daily."
];
